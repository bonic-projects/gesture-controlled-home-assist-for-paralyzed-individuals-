...
class CameraService {
  final logger = getLogger('CameraService');
  ...
  Function(InputImage inputImage)? _onImage;
  ...
  void initialize(
    ...
    if (_cameraIndex != -1) {
      _startLiveFeed(isMounted, onCameraFeedReady: onCameraFeedReady);
    }
  }
  ...
  void _processCameraImage(CameraImage image) {
    ...
    _onImage?.call(inputImage); // Call the stored onImage function
